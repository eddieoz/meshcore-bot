...
class GlobalWxCommand(BaseCommand):
    ...
    def __init__(self, bot):
        ...
        self.default_state = self.bot.config.get('Weather', 'default_state', fallback='Tallinn')
        self.default_country = self.bot.config.get('Weather', 'default_country', fallback='EE')
